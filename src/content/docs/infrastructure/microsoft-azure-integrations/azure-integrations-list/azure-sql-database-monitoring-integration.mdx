...
<Callout variant="important" title="EOL NOTICE">
  In January 2024, we'll be discontinuing support for this integration. You can now use the new Azure Monitor integration. See how to [set up Azure Monitor integration](/docs/infrastructure/microsoft-azure-integrations/azure-integrations-list/azure-monitor/).
</Callout>
